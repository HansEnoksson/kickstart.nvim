...
-- Conceallevel set to 1 for Obsidian.nvim to work properly
...
vim.keymap.set('n', '<leader>ll', function()
  -- Create a terminal buffer and run lazygit
  vim.cmd 'terminal lazygit'
  -- Enter Terminal mode by specifying insert mode
  vim.cmd 'startinsert'
end, { desc = 'Open Lazygit directly' })
...
require('lazy').setup({
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- See documentation that cursor is hovering over
...

  {
    ...
    opts = {
      dashboard = {
        theme = 'doom', -- Available themes: doom, hyper
        header = {
          '                                                     ',
          '  ███╗   ██╗███████╗ ██████╗ ██╗   ██╗██╗███╗   ███╗ ',
          '  ████╗  ██║██╔════╝██╔═══██╗██║   ██║██║████╗ ████║ ',
        ...
        shortcut = {
          ...
          { desc = 'Configuration', group = 'Number', action = 'e $MYVIMRC', key = 'c' },
        },
        footer = {
